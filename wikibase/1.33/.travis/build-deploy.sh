...
set -e
docker build "$DIR/../base" -t wikibase/wikibase:1.33 -t wikibase/wikibase:1.33-base -t wikibase/wikibase:latest -t wikibase/wikibase:latest-base
docker build "$DIR/../bundle" -t wikibase/wikibase:1.33-bundle -t wikibase/wikibase:latest-bundle
